...
public class Reports extends AppCompatActivity {
    ...
    public void getlist2(){
        ...
        while (cursor.isAfterLast() == false) {
            ...
            values.add(new SubcolumnValue(Integer.valueOf(Amm),ChartUtils.COLOR_BLUE).setLabel(month_name[Integer.parseInt(monthname)-1]));
            cursor.moveToNext();
        }
        barData.add(new Column(values).setHasLabels(true));
        view_barchart();
    }
